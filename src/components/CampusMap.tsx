    ...
    <>
      ...
      >
        ...
        <path
          ...
          onClick={() => setSelectedBuilding('SEC A')}
        ></path>
        {/* SEC B */}
        <rect
          x='336'
          ...
          fill={unselectedColor}
          onClick={() => setSelectedBuilding('SEC B')}
        ></rect>
        {/* SEC C */}
        <rect
          x='297.434'
          ...
          fill={unselectedColor}
          onClick={() => setSelectedBuilding('SEC C')}
        ></rect>
        {/* Matteo */}
        <rect
          width='32.5519'
          ...
          fill={unselectedColor}
          onClick={() => setSelectedBuilding('Matteo Ricci Study Hall')}
        ></rect>
        {/* SOM */}
        <rect
          x='250.943'
        ...
        <path
          ...
          fill={unselectedColor}
          onClick={() => setSelectedBuilding('Arete')}
        ></path>
        {/* Social Business Building */}
        <path
          d='M266 210V145H324V210H266Z'
          fill={unselectedColor}
          onClick={() => setSelectedBuilding('Social Sciences Building')}
        ></path>
      </svg>
    </>
  );
